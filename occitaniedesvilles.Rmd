...
```{r commerces2, fig.height=3.5, fig.cap="Population moyenne de la commune nécessaire à une première installation de commerce en Occitanie."}
...
Le code source de l'analyse est disponible sur [GitHub](https://github.com/gdevailly/hackaviz_tlse2018).